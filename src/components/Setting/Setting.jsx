                ...
                {/* <BrowserRouter> */}
                    <div className="row d-xl-flex d-lg-flex d-md-block d-sm-block d-block">
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 left-blog">
                            ...
                            <Link to="/setting/account" className="sidebar_item w-100 bg-light d-flex mt-3">
                            ...
                            <Link to="/setting/address" className="sidebar_item w-100 bg-light d-flex mt-3">
                                <ul className="col-2 sidebar-icon d-flex justify-content-start align-items-center mt-2 ms-3">
                            ...
                            <Link to="/setting/payment" className="sidebar_item w-100 bg-light d-flex mt-3">
                                <ul className="col-2 sidebar-icon d-flex justify-content-start align-items-center mt-2 ms-3">
                            ...
                            <Link to="/setting/security" className="sidebar_item w-100 bg-light d-flex mt-3">
                                <ul className="col-2 sidebar-icon d-flex justify-content-start align-items-center mt-2 ms-3">
